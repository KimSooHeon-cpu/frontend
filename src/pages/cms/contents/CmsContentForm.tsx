...
import React, { useEffect, useState } from "react"; // React 기본 훅 // [251112] 원상복귀 : React 객체 사용하는 부분 있음
        ...
        */
        ...
        try {
            ...
            if (isEditMode) { // 수정 모드일 경우 (URL에 contentId 존재)
                ...
                await api.post(`http://16.176.33.172/api/cms/contents/update/${contentId}`, params, config);  // [251112] 수정 주소 다이렉트로 붙이기 
